...
export const PROVEN: Review = {
  plies: plies([
    ...
    [6, 1, -12, -26, [2, 3, 4], "inaccuracy", "estimated", false, 0.027],
...
export const ESTIMATED: Review = {
  plies: plies([
    ...
    [4, 3, 6, 6, [3], "best", "estimated", false, 0],
    [6, 1, -12, -26, [2, 3, 4], "inaccuracy", "estimated", false, 0.027],
    [8, 3, -20, -44, [2, 4], "inaccuracy", "estimated", false, 0.045],
    ...
    [18, 1, 99976, -99981, [0], "blunder", "estimated", false, 1.1],
  ]),
  turningPoint: null,
  biggestSwing: null,
  curve: curve([
...
ESTIMATED.biggestSwing =
  ESTIMATED.plies.filter((p) => p.drop > 0.25).reduce((m, p) => (p.drop > m.drop ? p : m));
