...
export const PREVIEW_STATES: PreviewCase[] = [
  ...
  {
    id: "chrome-online",
    caption: "playing a person — host, or type the code in",
    variant: CONNECT4,
    moves: [],
    fever: 0.35,
    chrome: { state: "online" },
  ...
  {
    id: "chrome-online-waiting",
    caption: "waiting for them — the code, at reading-across-a-room size",
    variant: CONNECT4,
    moves: [],
    fever: 0.35,
    chrome: { state: "online-waiting" },
  },
  {
    id: "chrome-desync",
    caption: "the desync report — no retry, because there is nothing to retry",
    variant: CONNECT4,
    moves: [3, 3, 4, 2, 4, 4, 5, 3, 2, 1],
    fever: 0.55,
    chrome: { state: "desync" },
  ...
  {
    id: "chrome-online-loss",
    caption: "losing to a person — no persona to lose to",
    variant: CONNECT4,
    moves: [3, 0, 3, 1, 3, 2, 3],
    fever: 1,
    chrome: { state: "online-outcome", status: "" },
  },
  {
    id: "chrome-hud",
